...
class ConsoleApp( Frame ):
    ...
    def sendpacket( self ):
        "Tell each host to sendpacket the next one."
        consoles = self.consoles[ 'hosts' ].consoles
        ...
        for console in consoles:
            ...
            console.sendCmd('python ' + 'sca.py ' + ip )
...
class Object( object ):
    ...
    def __init__( self, **kwargs ):
        assign( self, **kwargs )
c2 = RemoteController( 'c2', ip='10.102.10.242', port=6653 )

if __name__ == '__main__':
    setLogLevel( 'info' )
    network = TreeNet( depth=2, fanout=4, controller=c2)
    network.start()
